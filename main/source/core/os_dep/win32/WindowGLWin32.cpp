...
namespace GLHL {
	...
	void WindowGLWin32::swapBuffers(){
		SwapBuffers(hDC);		// Specific function of windows to swap the buffers between window buffer and GPU buffer
	}
	...
	bool WindowGLWin32::initializeWindow(){
		...
		hInstance = GetModuleHandle(NULL);				// Tomamos una instancia del programa para nuestra ventana.
